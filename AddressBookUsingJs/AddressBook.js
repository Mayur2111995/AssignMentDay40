...
addContact("Mayur","Bari","Ramsing Nagar","Shirpur","Maharashtra",425405,9067853112,"barimayur1265@gmail.com");
addContact("Mayu","Kalal","Prem Kamal","Mumbai","Maharashtra",425405,8007005426,"mayukalal12@gmail.com");
addContact("Ashwini","Harsha","ShindeColony","Dahisar","Maharashtra",440204,9785686522,"Ashwini@gmail.com");
addContact("pappu","Mali","Karvank naka","Shirpur","Maharashtra",425405,8598068457,"pappum@gmail.com");
addContact("manashree","bari","SahibaNagar","Shirpur","Maharashtra",425405,8767898954,"manashree@gmail.com");

// Editing a contact
editContact("Mayu","Kalal","PremKamalNagar","Shirpur","Maharashtra",425405,8007005426,"mayukalal@gmail.com");
console.log(addressBook.toString())

// Deleting a contact
deleteContact("Mayu","Kalal");
console.log(addressBook.toString());
...
addContact("Mayu","Kalal","PremKamalNagar","Shirpur","Maharashtra",425405,8007005426,"Mayurkalal@gmail.com");
